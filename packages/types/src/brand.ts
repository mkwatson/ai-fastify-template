 ...
 */
export type Unbranded<BrandedType> =
  BrandedType extends Brand<infer T, string> ? T : BrandedType;
 ...
 */
export type ExtractBrand<BrandedType> =
  BrandedType extends Brand<unknown, infer BrandName> ? BrandName : never;
 ...
 */
export type IsBranded<T, BrandName extends string> =
  T extends Brand<unknown, BrandName> ? true : false;
