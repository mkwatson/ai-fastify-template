...
describe('validatePasswordStrength', () => {
  ...
  it('should handle unknown errors gracefully', () => {
    ...
    // We can't easily mock the internal parse, so we'll create a custom validator
    const { validatePasswordStrength } = require('../../src/utils/validators.js');
    
    // Create a test that exercises the catch block for non-Zod errors
